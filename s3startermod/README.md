...
This is a sample template for s3startermod - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name s3startermod --query 'Stacks[].Outputs'
```
